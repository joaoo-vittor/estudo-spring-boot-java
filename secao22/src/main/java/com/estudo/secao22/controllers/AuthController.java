package com.estudo.secao22.controllers;
...
import com.estudo.secao22.data.vo.v1.security.AccountCredentialsVO;
import com.estudo.secao22.services.AuthServices;
...
public class AuthController {
  ...
  @SuppressWarnings("rawtypes")
  @Operation(
    summary = "Refresh token for authenticatied user and returns a token"
  )
  ...
  private boolean checkIfParamIsNotNull(

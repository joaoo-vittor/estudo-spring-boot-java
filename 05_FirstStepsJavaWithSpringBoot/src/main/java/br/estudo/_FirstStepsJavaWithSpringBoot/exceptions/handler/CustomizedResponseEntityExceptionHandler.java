package br.estudo._FirstStepsJavaWithSpringBoot.exceptions.handler;
...
import br.estudo._FirstStepsJavaWithSpringBoot.exceptions.ExceptionResponse;
import br.estudo._FirstStepsJavaWithSpringBoot.exceptions.UnsupportedMathOperationException;

@ControllerAdvice // tratar errors globalmente
@RestController
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {

  // @ExceptionHandler(value = { Exception.class }) // Trata as execoes mais genericas

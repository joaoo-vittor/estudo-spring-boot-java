package com.estudo.secao16.unittests.mockito.services;
...
import com.estudo.secao16.exceptions.RequiredObjectIsNullException;
import com.estudo.secao16.model.Person;
import com.estudo.secao16.repositories.PersonRepository;
import com.estudo.secao16.services.PersonServices;
    ...
    for (int i = 0; i < 14; i++) {
      ...
      assertTrue(
        result.toString().contains(
          String.format(
            "links: [</api/v1/person/%d>;rel=\"self\"]", 
            i
          )
        )
      );
      ...
      assertEquals(i % 2 == 0 ? "Male" : "Female", result.getGender());
    }
